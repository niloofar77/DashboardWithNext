...
export default function DashboardLayout({
  ...
  return (
    ...
    <div className="flex h-screen w-full overflow-hidden bg-white dark:bg-black">
      ...
      <div className="w-64 bg-gray-100 border-r border-gray-200 h-full overflow-y-auto  text-black dark:text-white">
      {showSidebar && (
        <SidebarProvider>
      ...
      <main className="flex-1 p-4 overflow-y-auto  text-black dark:text-white bg-white dark:bg-black">{children}</main>
      </div>
      </div>
</ProfileProvider>
